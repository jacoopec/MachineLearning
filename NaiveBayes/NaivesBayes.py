...
data = {
    'Age':    [   20,    22,    25,    47,     52,    46,     47,     56,    57,    55,    60,  61,      62,   61],
    'Income': [  50000, 15000, 29000, 48000, 60000, 52000,   23000,  65000, 34000 ,70000, 80000, 26000, 82000, 85000],
    'Buys':    [  'Yes', 'No',  'No', 'Yes', 'Yes', 'Yes',   'No'   ,'Yes', 'No',  'Yes', 'Yes', 'No',  'Yes', 'Yes']
}
