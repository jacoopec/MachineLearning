...
Spam vs not spam (bag-of-words)
Fraud vs normal (simple signals)
Disease present vs absent (clinical risk factors)
Customer churn vs retained

Why it works:
Signal is additive
Effects are approximately linear in log-odds
